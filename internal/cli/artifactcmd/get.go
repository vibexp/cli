...
func newGet(resolve resource.CredResolver, getenv config.Getenv) *cobra.Command {
	return &cobra.Command{
		...
		Long:  "Show a single artifact by slug within the resolved project (--project, VIBEXP_PROJECT, or the active context).",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return resource.Render(cmd, rt, getenv, body, &itemSpec)
		},
	}
}
